...
<head>
  ...
  <title>FSI-Blog | Data Pengguna</title>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
				...
				<?php foreach ($data->result_array() as $i) :
                       ...
                       $pengguna_dept_id=$i['pengguna_dept_id'];
                    ?>
                <tr>
                  ...
                  <?php elseif($pengguna_level=='4'):?>
                        <td>HRD</td>
                  <?php elseif($pengguna_level==''):?>
                        <td>n/a</td>
                  <?php endif;?>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $pengguna_id;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" href="<?php echo base_url().'it/pengguna/reset_password/'.$pengguna_id;?>"><span class="fa fa-refresh"></span></a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'it/pengguna/simpan_pengguna'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xdepartement" required>
                                                <option value="">-- Pilih Departement --</option>
                                                  <?php foreach ($dept->result_array() as $a ) :?>
                                                    <option value="<?php echo $a['dept_id'] ?>"><?php echo $a['dept_name']; ?></option>
                                                  <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xlevel" required>
                                                ...
                                                <option value="3">Manager Departement</option>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $pengguna_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'it/pengguna/update_pengguna'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xdepartement" required>
                                                <option value="">-- Pilih Departement --</option>
                                                <?php
                                                foreach ($dept->result_array() as $b) {
                                                 $dept_id = $b['dept_id'];
                                                 $dept_name = $b['dept_name'];

                                                 if($pengguna_dept_id==$dept_id)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <?php elseif($pengguna_level=='3'): ?>
                                                <option value="1">Admin</option>
                                                <option value="2">IT</option>
                                                <option value="3" selected>Manager Departement</option>
                                            <?php elseif($pengguna_level==''):?>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $pengguna_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'it/pengguna/hapus_pengguna'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $pengguna_id;?>"/>
