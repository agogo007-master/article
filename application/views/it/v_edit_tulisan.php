  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'it/tulisan/update_tulisan'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Bahasa</label>
                <select class="form-control select2" name="xbahasa" style="width: 100%;" required>
                  <option value="">-Pilih Bahasa-</option>
                    <?php
                    foreach ($bah->result_array() as $s) {
                                 $lang_id=$s['lang_id'];
                                 $lang_description=$s['lang_description'];

                                 if($b['tulisan_lang']==$lang_id)
                                    echo "<option value='$lang_id' selected>$lang_description</option>";
                                 else
                                    echo "<option value='$lang_id'>$lang_description</option>";
                    }?>
