        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['title'];?>" placeholder="Judul berita atau artikel" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-1">
          ...
          <div class="col-md-1">
              <div class="form-group">
                <button type="button" onclick="window.history.back();" class="btn btn-default btn-flat pull-right"><span class="fa fa-remove"></span> Cancel</button>
              </div>
          </div>
          <!-- /.row -->
        </div>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
			       ...
			       <textarea id="ckeditor" name="xisi" required><?php echo $b['content'];?></textarea>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="xstatus" required="">
                  ...
                  <?php elseif ($b['status'] == 'Publish') :?>
                    ...
                    <option>Trash</option>
                  <?php elseif ($b['status'] == 'Trash') :?>
                    <option>Draft</option>
                    <option>Publish</option>
                    <option selected="">Trash</option>
                  <?php endif; ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="xcategory" value="<?php echo $b['category'] ?>" required>
              </div>
