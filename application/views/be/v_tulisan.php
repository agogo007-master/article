...
<head>
  ...
  <title>FSI-Blog | List Berita</title>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <?php if ($i['status'] == 'Open') :?>
                            <a class="btn" data-toggle="modal" data-target="#ModalPublish<?php echo $i['id'];?>"><span class="fa fa-check" title="Publish"></span></a>
                        <?php endif; ?>
                        <a class="btn" href="<?php echo base_url().'admin/tulisan/get_edit/'.$i['id'];?>"><span class="fa fa-pencil" title="Edit"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $i['id'];?>"><span class="fa fa-trash" title="Unpublish"></span></a>
                    </td>
                </tr>
				<?php endforeach;?>
                </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <p>Apakah Anda yakin mau menghapus Posting <b><?php echo $i['title'];?></b> ?</p>
