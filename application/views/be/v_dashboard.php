      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-blue">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Counter Investor & Currently</span>
              <!-- <div class="row"> -->
                <div class="col-md-6">
                  <span style="text-align: left;" class="info-box-number">23</span>
                </div>
                <div class="col-md-6">
                  <span style="text-align: right;" class="info-box-number">24</span>
                </div>
              <!-- </div> -->
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
                ...
                <div class="col-md-6">
                  <span style="text-align: left;" class="progress-description">
                    Investor
                  </span>
                </div>
                <div class="col-md-6">
